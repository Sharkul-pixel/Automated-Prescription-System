      ...
      <div className="flex h-[92vh]">
        <aside className="flex w-1/4 flex-col border-r border-slate-300 bg-slate-100">
          ...
          >
            ...
            <span className="mx-1.5 text-lg">Patients</span>
          </NavLink>
          <NavLink
            to={`/messages`}
            className={({ isActive }) =>
          ...
          >
            ...
            <span className="mx-1.5 text-lg">Messages</span>
          </NavLink>
          <NavLink
            to={`/settings`}
            className={({ isActive }) =>
          ...
          <div
            className={
              "flex cursor-pointer items-center border-t border-slate-300 px-3 py-4 hover:bg-slate-200"
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="mx-1.5 text-lg">Sign out</span>
          </div>
        </aside>
